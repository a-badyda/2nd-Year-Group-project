...
/**
 * A class responsible for handling all the requests and responses to the database and the server. 
 *@author Christopher Lloyd (chl24)
 */
public class GameServer extends HttpServlet {
    ...
    /**
     * doGet responsible for performing actions in response to requests
     * @param request the request recieved
     * @param response the response to be supplied
     */
	...
	/**
	 *   IsLoggedIn checks wether user is logged in and prints the output for later use
	...
	/**
	 *   GetUserData requests the user's name and key id to then output the username and cash values 
	 * @param request the request from the client-side;
	 * @param response the response from the server; 
	 */
	...
	/**
	 *   doPost recives all the requests from the client side 
	...
	/**
	 *   LogIn  loads in the user into the server and validates all of it- 
	...
	/**
	 *   LogOut removes the user from the current server session
	 * @param request the request from the client-side;
	 * @param response the response from the server;
	 */
	...
	/**
	 *   NewUser creates a new user and a monster for them, inserting it into the database
	 * @param request the request from the client-side;
	 * @param response the response from the server;
	 */
	...
	/**
	 *   addFriend a method tries to find the matching string in database and if it is found, the match is sent a friend request
	...
	/**
	 *   newBattleRequest Sends out the request to marked user with a marked user's monster that is required for battle
	...
	/**
	 *   the request is sent out, the user who accepted is first looses cash, then babies are generated and added into his monster list 
	...
	/**
	 *   newBuyRequest gets the id of the selling/buying users and the sold monster,set the buying user's cash to current ammount - price
	...
	/**
	 *   getMonsters Outputs all monsters one at a time with all their stats in a set order:
	...
	/**
	 *   getFriends  prints the list of user's friends with their username, id, server address.
	 * @param request the request from the client-side;
	 * @param response the response from the server; 
	 */
	...
	/**
	 *   getFriendsMonsters prints friends' monsters in the following format: 
	 *name, ID, is it available to buy or breed, buy cost, cost to breed, strength, health, fertility, defence, aggression, breed.
	 *@param request the request from the client-side;
	 * @param response the response from the server;
	 */
	...
	/**
	 *   changeName updates the name field with a new value for the chosen monster_id 
	 */
	...
	/**
	 *   getAllResults gets the user's username and id from the database;  gets type of request;
	...
	/**
	 *   getAllRequest prints all current notifications for the user that have not been accepted/rejected/viewed.
	 * @param request the request from the client-side;
	 * @param response the response from the server;
	 */
	...
	/**
	 *   acceptRequest marks the request as 'accepted'.
	 * @param request the request from the client-side;
	 * @param response the response from the server;
	 */
	...
	/**
	 *  acceptBattleRequest confirms the request sent from one user to another asking for battle
	...
	/**
	 *   acceptFriendRequest First, the notification is deleted, then the id of both users are exchanged and put into their lists of 'friends', 
	...
	/**
	 *   declineRequest allows the user to reject and 'drop/fail' the requests sent to him, and then deletes it from the notification list.
	 * @param request the request from the client-side;
	 * @param response the response from the server;
	 */
	...
	/**
	 *   getRichList generates a list of all the users' friends (+user) and sorts them from lowest to highiest cash value.
	 * @param request the request from the client-side;
	 * @param response the response from the server;
	 */
	...
	/**
	 *   reloadFriends method allowing you to update the friend list it seems.
	 * @param request the request from the client-side;
	 * @param response the response from the server;
	 */
	...
	/**
	 *   reloadmonsters allows monsters to be updated during one session without shutting the server down and turning it on again.
	 * @param request the request from the client-side;
	 * @param response the response from the server;
	 */
	...
	/**
	 *   reloadnotifications same case like other reloads.
	 * @param request the request from the client-side;
	 * @param response the response from the server;
	 */
